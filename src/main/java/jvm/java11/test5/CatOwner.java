...
public final class CatOwner {
    ...
    public final void increaseSize() {
        final var previousSize = this.cat.optionalSize();
    ...
    public final void changeName(@NotNull final String nameSuffix) {
        ...
        final var previousName = this.cat.optionalName();
        this.cat.setOptionalName(previousName.map((@NotNull final var pn) -> pn + nameSuffix));
    }
}
